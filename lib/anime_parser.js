...
const seasons_url = 'https://gogoanime3.cc/new-season.html';

const Referer = 'http://www111.anzeat.pro/';
const goload_stream_url = 'https://www111.anzeat.pro';
...
export const scrapeWatchAnime = async ({ id }) => {
  try {
    ...
    const WatchAnime = await axios.get(`https://gogoanime3.cc/${id}`);
